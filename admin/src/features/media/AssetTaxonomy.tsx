 ...
 * picker entries use. Assets share the entry taxonomies but take no entry-component values. Saves immediately.
 */
    ...
    <section className="panel-section">
      ...
      {pickerOpen && (
        <TaxonomyPicker
          ...
          attributes={false}
          current={current.map((nodeId) => ({ nodeId, entryComponentValues: null }))}
          onSave={(next) => {
