...
export function TaxonomyPicker({
  ...
  current: Attachment[];
  title?: string;
  /** false = hide the entry-component chips — assets take no entry-component values */
  attributes?: boolean;
          ...
          <button
            ...
            onClick={() => {
              ...
              const added = [...selected]
                ...
                .map((nodeId) => ({ nodeId, entryComponentValues: null }));
              onSave([...keep, ...added]);
            }}
          >
            Apply
