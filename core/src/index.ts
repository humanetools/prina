...
async function main(): Promise<void> {
  ...
  // Split deployment: only the admin (or single) instance runs it; delivery replicas stay stateless.
  const stopEmbedWorker = env.PRINA_PLANE === "delivery" ? () => {} : startEmbeddingWorker(db);
