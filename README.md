...
- **Delivery** — JSON API, **GraphQL** (read-only, schema generated from your types: filters, ordering, nested relations/media), Liquid HTML fragments, `embed.js` widgets, GA4 dataLayer
